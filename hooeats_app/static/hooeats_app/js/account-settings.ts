...
const changeProfileImage = (imageUrl: string) => {
    const profileImage = document.getElementById("profile-image");
    const profileImageField = document.getElementById("profile-image-field") as HTMLInputElement;
...
const toggleSettings = (showGeneral: boolean) => {
